...
uses
  classes, sysutils,  windows, StrUtils, ACompletion;
...
uses
 // uAutoCorrect replaced with Borno's PostCorrectionEx
  ...
  //added
  BornoAI,
		//removed WindowsVersion,
		    //changed       uRegistrySettings;
  Reg_RW;
{ TEnglishToBangla }
...
begin
  ...
  if EnglishT = '' then
    Exit;
		 ...
		 // Disabled to fix unexpected conversion // Unstable
